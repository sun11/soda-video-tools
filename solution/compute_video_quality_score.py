...
from dover.dover.datasets import (
    UnifiedFrameSampler,
    ViewDecompositionDataset,
    spatial_temporal_view_decomposition,
)
from dover.dover.models import DOVER
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--input_jsonl",
        type=str,
        help="the input video jsonl filelist",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="./demo.csv",
        help="the score result csv file",
    )

    parser.add_argument("--output_jsonl", type=str, default="video_quality_score.jsonl", help="jsonl format score file")
    ...
    dopt["anno_file"] = None
    dopt["data_prefix"] = "dj_video"
    dopt["input_jsonl"] = args.input_jsonl
    ...
    for i, data in enumerate(tqdm(dataloader, desc="Testing")):
        ...
        if args.output_jsonl:
            with open(args.output_jsonl, 'a') as f:
                json_obj = {
                    "videos": [data["name"][0]],
                    "aesthetic": f'{rescaled_results["aesthetic"]*100:4f}',
                    "technical": f'{rescaled_results["technical"]*100:4f}',
                    "overall": f'{rescaled_results["overall"]*100:4f}',
                }
